    ...
    >
      ...
      <div className="text-white" id="about2">
        ...
        <AboutUsInfo
          num={1}
          title="Бидний тухай"
          body="Хүрээ МХТС-ийн Компьютерийн ухааны тэнхимийн дэргэдэх клуб бөгөөд Манай клубийн үйл ажиллагаа бол оюутнуудад чиглэсэн сургалт, бусад үйл ажиллагааг тогтмол зохион байгуулах юм."
          color="#4392F5"
        />
        <AboutUsInfo
          num={2}
          ...
          зүйлээ бусаддаа хуваалцах, бусдаас суралцах. Mentor, menting-тэй
          харилцаа холбоо."
          color="#56CB7A"
        />
        <AboutUsInfo
